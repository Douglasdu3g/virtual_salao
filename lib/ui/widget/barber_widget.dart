    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: disponivelHoje ? AppColors.blue : Colors.grey.shade300,
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: disponivelHoje ? AppColors.white : Colors.black,
                    ),
                  ),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: 12,
                        color:
                            disponivelHoje ? AppColors.white : Colors.black87),
